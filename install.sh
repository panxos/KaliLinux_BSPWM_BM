...
sudo cp -v $ruta/scripts/htbExplorer /usr/local/bin/
...
sudo chmod +x /usr/local/bin/htbExplorer
...
notify-send "BSPWM INSTALADO, veridica parameyros de interfaces de red, configura HTbexplorer con la api de Hack Te box y resvvisa los alias de .zshrc"
